...
import { FileText, DollarSign, Percent } from 'lucide-react-native';
          ...
          >
            ...
            <TouchableOpacity
              ...
              style={{
                ...
                backgroundColor:
                  splitType === 'amount' ? COLORS.premium : 'transparent',
              }}
            >
              <DollarSign
                size={18}
              ...
              <View style={{ marginLeft: SPACING.sm }}>
                <Text
                  style={{
                    ...
                    fontWeight: FONT_WEIGHTS.semibold,
                    color:
                      splitType === 'amount' ? COLORS.background : COLORS.text,
                  }}
                >
                  Fixed Amount
                </Text>
            ...
            <TouchableOpacity
              ...
              style={{
                ...
                borderRadius: BORDER_RADIUS.sm,
                backgroundColor:
                  splitType === 'percentage' ? COLORS.premium : 'transparent',
              }}
            >
              <Percent
                size={18}
                color={
                  splitType === 'percentage' ? COLORS.background : COLORS.text
                }
              />
              <View style={{ marginLeft: SPACING.sm }}>
                <Text
